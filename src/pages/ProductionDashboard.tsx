...
const DailyProductionView = React.lazy(() => import('../components/ProductionTabs/DailyProductionView'));
const SummaryAnalytics = React.lazy(() => import('../components/ProductionTabs/SummaryAnalytics'));
