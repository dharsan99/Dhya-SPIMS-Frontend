...
import { adminAcceptInvite } from '@/api/superadmintenantusers';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user_id) {
        ...
        setTimeout(() => {
          navigate('/superadmin/tenant-users');
        }, 2000);
      } else {
        setStatus('error');
        ...
        >
          ...
          {status === 'success' && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Redirecting to tenant users page...
              </p>
            </div>
          )}
          ...
          {status === 'error' && (
            <div className="text-center">
              ...
              <button
                onClick={() => navigate('/superadmin/tenant-users')}
